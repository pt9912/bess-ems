...
Form-Hinweis: einige Arbeitspakete tragen ihre volle DoD inline in der
Tabelle unten, andere verweisen auf einen eigenen Slice-Plan unter
`docs/plan/planning/done/plan-RM-M4-XX.md`. Die Asymmetrie folgt der
projektweiten Slice-Plan-Konvention (siehe
[`../in-progress/roadmap.md`](../in-progress/roadmap.md#slice-plan-konvention)
Wartungssektion): eigener Slice-Plan bei Sub-Slice-Breakdown / Multi-
Wochen-Aufwand / ≥5 Design-Entscheidungen / Review-Pass-Iterationen;
sonst Inline-DoD. In M4 ist die Verteilung: RM-M4-01/02/06/07 inline,
RM-M4-03/04/05/08 eigener Slice-Plan.
