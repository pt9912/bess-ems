...
| ✅      | RM-M1-F04   | nach-MVP-Punkt   | Schedule-Optimizer und Run-Persistenz planen | LH-OPT-001/007/009, LH-PERSIST-007 | [`../in-progress/plan-RM-M2-optimization.md`](../in-progress/plan-RM-M2-optimization.md) ist der aktive Detailplan für `IScheduleOptimizer`-Implementierung, `OptimizationRun`/`IOptimizationRunRepository`, Solverstatus und Objective-Breakdown. M1 bleibt bei Import/Tracking von Fahrplänen und Echtzeit-Dispatch; die Roadmap-Sektion M2 verweist auf den Plan. |
