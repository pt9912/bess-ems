...
**Dokumenttyp:** Detailplan / M5 (abgeschlossen)
**Status:** Abgeschlossen am 2026-05-13. Aktiviert am 2026-05-11 nach
Abschluss von M4 und ADR 0005 (gRPC-Adoption schließt AR-OPEN-002).
RM-M5-01 hat eigenen Slice-Plan [`plan-RM-M5-01.md`](plan-RM-M5-01.md) (abgeschlossen am 2026-05-11 inkl. Sub-Slice-C-Korrektur-Pass). RM-M5-02 hat eigenen Slice-Plan [`plan-RM-M5-02.md`](plan-RM-M5-02.md) (abgeschlossen am 2026-05-12 — MPC-Kernel-Backend mit Local-OSQP, Kalman-Estimator, Replay-Stempeln und Production-Gates). RM-M5-04 hat eigenen Slice-Plan [`plan-RM-M5-04.md`](plan-RM-M5-04.md) (abgeschlossen am 2026-05-12 — Manifest-/Fixture-/Golden-Diff-Grundlage, M2/M3-Migration, Replay-Diff-Reports und Sidecar-/MPC-Engine-Vergleiche). RM-M5-05 hat eigenen Slice-Plan [`plan-RM-M5-05.md`](plan-RM-M5-05.md) (abgeschlossen am 2026-05-12 — Prometheus-Metriken fuer Sidecar-Health, Fallback-Taxonomie, Terminalzustand und Laufzeit). RM-M5-06 hat eigenen Slice-Plan [`plan-RM-M5-06.md`](plan-RM-M5-06.md) (abgeschlossen am 2026-05-12 — Worker-plus-Sidecar-Compose-Gate mit Sidecar-Stopp, Fallback und Restart). RM-M5-07 hat eigenen Slice-Plan [`plan-RM-M5-07.md`](plan-RM-M5-07.md) (abgeschlossen am 2026-05-12 — source-neutraler Preisreihen-Port plus Import/API-Referenzpfad).
RM-M5-03 hat eigenen Slice-Plan [`plan-RM-M5-03.md`](plan-RM-M5-03.md) (abgeschlossen am 2026-05-13 — nativer Hochfrequenz-Telemetrie-Filter mit ABI 0.3.0, P/Invoke-Wiring und Native-Gates).
**Bezug:**
...
- MPC-Kernel mit State-Space-Modell, Schaetzer-/Kalman-Pfad,
  ...
  notwendig.
- Native-Core-Slice fuer hochfrequente Telemetrie-Filterung, wenn
  der MPC-/State-Space-Pfad diese Vorverarbeitung oder niedrigere
  Latenz braucht.
...
| Native | Hochfrequente Telemetrie-Filterung im nativen Pfad | LH-NATIVE-001 |
...
2. ✅ Security-Freeze fuer RM-M5-01 abgeschlossen: AuthN/AuthZ,
   ...
   in den Sidecar-Contract- und Security-Pins abgedeckt.
3. ✅ RM-M5-01 als schmaler Contract-Slice gebaut: Health, Version,
   Test-Sidecar, Deadline, Idempotenz, Fallback und Status-Mapping.
4. ✅ RM-M5-05 parallel zum Sidecar-Pfad abgeschlossen; Sidecar-Fehler,
   Deadlines, Terminalzustaende und Fallbacks sind observierbar.
5. ✅ RM-M5-06 als Container-Gate abgeschlossen; Worker und Test-Sidecar
   laufen im Compose-Gate inklusive Stop/Fallback/Restart-Pins.
6. ✅ RM-M5-07 parallel zur Optimierungs-/Replay-Basis abgeschlossen.
   Der Slice liefert Port, Modell und Import/API-Default, keine externen
   Anbieteradapter.
7. ✅ RM-M5-04 zur Replay-Plattform ausgebaut; bestehende M2/M3-Replay-
   Fixtures bleiben ueber Manifest-/Kompatibilitaets- und Vergleichspfade
   lauffaehig.
8. ✅ RM-M5-02 auf stabilem Contract-/Replay-Fundament abgeschlossen,
   damit numerische Drift und Constraint-Verletzungen reproduzierbar
   diskutiert werden koennen.
9. ✅ RM-M5-03 schliesst den Native-Filterpfad mit schmalem Vertrag,
   C-API-Erweiterung, P/Invoke-Wiring und Native-Gates
