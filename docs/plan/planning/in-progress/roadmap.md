...
| 🟡     | M5          | MPC, Solver-Sidecar, Replay        | 3     | [`plan-RM-M5.md`](plan-RM-M5.md) — aktiviert 2026-05-11 nach M4-Closure und [ADR 0005](../../adr/0005-optimization-core-sidecar-transport.md) (schließt `AR-OPEN-002`). RM-M5-01 (gRPC-Sidecar Contract-Slice) ✅ am 2026-05-11 abgeschlossen inkl. Sub-Slice-C-Korrektur-Pass — Detail-Slice [`../done/plan-RM-M5-01.md`](../done/plan-RM-M5-01.md); RM-M5-02..06 offen. Folgearbeiten F-M5-01..05 in [`../open/note-RM-M5-followups.md`](../open/note-RM-M5-followups.md). |
