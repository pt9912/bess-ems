...
| 🟡     | M5          | MPC, Solver-Sidecar, Replay        | 3     | [`plan-RM-M5.md`](plan-RM-M5.md) — aktiviert 2026-05-11 nach M4-Closure und [ADR 0005](../../adr/0005-optimization-core-sidecar-transport.md) (schließt `AR-OPEN-002`). RM-M5-01 (gRPC-Sidecar Contract-Slice) ✅ am 2026-05-11 abgeschlossen inkl. Sub-Slice-C-Korrektur-Pass — Detail-Slice [`../done/plan-RM-M5-01.md`](../done/plan-RM-M5-01.md). RM-M5-02 (MPC-Kernel) offen mit eigenem Detail-Slice [`plan-RM-M5-02.md`](plan-RM-M5-02.md); RM-M5-03..06 offen. Folgearbeiten F-M5-01..05 in [`../open/note-RM-M5-followups.md`](../open/note-RM-M5-followups.md). |
...
| ⬜     | RM-M5-02   | MPC-Kernel (State-Space, Kalman, Vorhersagehorizont) — Detail-Slice [`plan-RM-M5-02.md`](plan-RM-M5-02.md) (offen, vier Sub-Slices A..D; D-02 Solver-Backend-Wahl ggf. ADR-Trigger für `adr/0006-mpc-kernel-modeling-and-solver.md`). | LH-CTRL-005/006         |
