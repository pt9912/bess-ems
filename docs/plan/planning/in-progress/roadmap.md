...
| ✅     | RM-M1-02   | Domain-Modell (BatteryAsset, Telemetry, Command, DataQuality)       | [LH-DOM-001](../../../../spec/lastenheft.md#lh-dom-001--batteriespeicher-modell)..004           |
| ✅     | RM-M1-03   | Realtime Snapshot Store, Datenfusion, Aging                         | [LH-RT-001](../../../../spec/lastenheft.md#lh-rt-001--realtime-snapshot-store)..004            |
| ✅     | RM-M1-04   | State Machine (INIT…EMERGENCY_STOP) inkl. Quittierungslogik         | [LH-SM-001](../../../../spec/lastenheft.md#lh-sm-001--explizite-betriebszustände)..003            |
...
| ✅     | RM-M1-07   | Regelzyklus 1 s, sicherer Fallback bei stale/ungültigem Snapshot    | [LH-CTRL-001](../../../../spec/lastenheft.md#lh-ctrl-001--zyklischer-regelkreis)/007, [LH-RT-003](../../../../spec/lastenheft.md#lh-rt-003--maximales-messwertalter) |
...
| ✅     | RM-M1-09   | Modbus-TCP-Adapter (Lesen + Schreiben, Mapping über Config)         | [LH-MODB-001](../../../../spec/lastenheft.md#lh-modb-001--modbus-tcp-lesen)..005          |
| ✅     | RM-M1-10   | MQTT-Adapter (Telemetrie-Empfang, Command-Publish, Topic-Konvention) | [LH-MQTT-001](../../../../spec/lastenheft.md#lh-mqtt-001--mqtt-telemetrie-empfang)..003         |
...
| ✅     | RM-M1-12   | Statischer Fahrplanimport, `MarketCommitment`-Modell, UTC/DST-Zeitmodell + Day-Ahead-Verfolgung | [LH-MKT-001](../../../../spec/lastenheft.md#lh-mkt-001--day-ahead-fahrplan)/003/006/007 |
| ✅     | RM-M1-13   | PostgreSQL-Persistenz: Dapper + Npgsql 9, idempotente DDL, Repos für Telemetrie/Commands/Fahrpläne/Audit, Postgres-Sidecar im Compose-Integrationstest. DI-/Runtime-Wiring bleibt RM-M1-15/19. | [LH-PERSIST-001](../../../../spec/lastenheft.md#lh-persist-001--speicherung-von-messdaten)..005       |
...
| ✅     | RM-M1-15   | API: Health, Status, Current Command, Schedules, Operator-Stop      | [LH-API-001](../../../../spec/lastenheft.md#lh-api-001--health-endpoint)..004, [LH-API-006](../../../../spec/lastenheft.md#lh-api-006--operator-stop) |
...
| ✅     | RM-M1-24   | Go-basierter Blackbox-Simulator `simulators/bess-field-sim` für Modbus/MQTT, Szenario-Fixtures und Runtime-Smoke | [LH-TEST-003](../../../../spec/lastenheft.md#lh-test-003--integrationstests-für-protokolladapter)/006/007, [LH-PROT-001](../../../../spec/lastenheft.md#lh-prot-001--einheitliches-adapterinterface) |
...
(RM-M2-03/05/07/09 und Anschluss an [LH-OPT-007](../../../../spec/lastenheft.md#lh-opt-007--trennung-von-horizon-optimierung-und-echtzeit-dispatch)/008/009 + [LH-PERSIST-007](../../../../spec/lastenheft.md#lh-persist-007--speicherung-von-optimierungsläufen))
...
| ✅     | RM-M2-03   | LP-Implementierung des `IScheduleOptimizer` für Horizon-Optimierung (Solver-Auswahl per Config) | [LH-OPT-001](../../../../spec/lastenheft.md#lh-opt-001--fahrplanoptimierung)..009     |
...
| Status | ID         | Inhalt                                                              | LH-Bezug                   |
| ------ | ---------- | ------------------------------------------------------------------- | -------------------------- |
| ✅     | RM-M3-01   | C-ABI `battery_control_core.h` (Snapshot/Limits/Command Structs)    | [LH-NATIVE-002](../../../../spec/lastenheft.md#lh-native-002--stabile-c-abi)/003          |
| ✅     | RM-M3-02   | Implementierung Constraint + Ramp + Statuscode-Fehlerpfade (Sprach-Pivot C++ → C unter RM-M3-09) | [LH-NATIVE-001](../../../../spec/lastenheft.md#lh-native-001--cc-für-performance-kritische-komponenten)/004 |
...
| ✅     | RM-M3-06   | Multi-Stage Dockerfile mit Native-Build-Stage (Teil 1 Build-Stage; Teil 2 Runtime-Image-Pfad `/app/native/` + Container-Smoke) | [LH-DEPLOY-003](../../../../spec/lastenheft.md#lh-deploy-003--multi-stage-build)/004, [LH-NATIVE-006](../../../../spec/lastenheft.md#lh-native-006--container-build) |
