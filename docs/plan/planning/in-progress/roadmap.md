...
> **M6 aktiviert** ([`plan-RM-M6.md`](plan-RM-M6.md)): erster Slice ist
> RM-M6-02 ([`plan-RM-M6-02.md`](plan-RM-M6-02.md)). ADR 0007 schliesst
> `AR-OPEN-006`: shared Worker mit per-Asset fan-out ist der Default,
> Worker-pro-Asset bleibt Deployment-/Isolation-Pattern. Operator-UI,
> TimescaleDB, Edge und zertifizierungsnahe Regelleistungsintegration
> bleiben in M6 eingeplant, aber trigger-/topologieabhaengig.
>
...
| 🟡     | M6          | Skalierung, UI, Edge / Multi-Asset | 4     | [`plan-RM-M6.md`](plan-RM-M6.md) — aktiviert 2026-05-13 nach M5-Closure. Erster Slice: RM-M6-02 [`plan-RM-M6-02.md`](plan-RM-M6-02.md); [ADR 0007](../../adr/0007-multi-asset-hosting-strategy.md) schliesst `AR-OPEN-006` mit shared Worker als Default. UI, Kubernetes, TimescaleDB, Edge und zertifizierungsnahe Regelleistung bleiben nachgelagerte M6-Slices. |
...
| 🟡     | RM-M6-02   | Multi-Asset-Flottensteuerung / Hosting-Strategie — Slice-Plan [`plan-RM-M6-02.md`](plan-RM-M6-02.md); [ADR 0007](../../adr/0007-multi-asset-hosting-strategy.md) schliesst `AR-OPEN-006` mit shared Worker als Default und Worker-pro-Asset als Deployment-/Isolation-Pattern. | §28.3                |
