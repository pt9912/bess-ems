...
> [`plan-RM-M5-01.md`](plan-RM-M5-01.md) (🟡 in Korrektur-Pass nach
> externem Review am 2026-05-11). Phase-4-Pivot-Trigger (harter
...
| 🟡     | M5          | MPC, Solver-Sidecar, Replay        | 3     | [`plan-RM-M5.md`](plan-RM-M5.md) — aktiviert 2026-05-11 nach M4-Closure und [ADR 0005](../../adr/0005-optimization-core-sidecar-transport.md) (schließt `AR-OPEN-002`). RM-M5-01 (gRPC-Sidecar Contract-Slice) 🟡 in Korrektur-Pass nach externem Review am 2026-05-11 — Detail-Slice [`plan-RM-M5-01.md`](plan-RM-M5-01.md); RM-M5-02..06 offen. Folgearbeiten F-M5-01..04 in [`../open/note-RM-M5-followups.md`](../open/note-RM-M5-followups.md). |
...
| Status | ID         | Inhalt                                                              | LH-Bezug                |
| ------ | ---------- | ------------------------------------------------------------------- | ----------------------- |
| 🟡     | RM-M5-01   | gRPC-Sidecar `optimization-core` (LP/MILP/MPC) — Detail-Slice [`plan-RM-M5-01.md`](plan-RM-M5-01.md) (Sub-Slice C 🟡 in Korrektur-Pass); gRPC-Transport per [ADR 0005](../../adr/0005-optimization-core-sidecar-transport.md), UDS-Default + mTLS-Cross-Host, In-Process TestSidecar via Grpc.AspNetCore. | LH-OPT-002/003/006      |
