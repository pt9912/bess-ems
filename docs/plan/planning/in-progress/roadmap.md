...
| ✅     | M2          | Marktausbau und Optimierung        | 1 → 2 | Abgeschlossen ([Optimization-Slice](../done/plan-RM-M2-optimization.md) plus RM-M2-01..10 in der Tabelle unten); [Migrations-Tooling](plan-RM-M2-migration.md) liegt unter `in-progress/` (MIG-01..06 lokal umgesetzt), [HIL](../open/HIL-simulator.md) bleibt unter `open/` |
