...
| 🟡     | M6          | Skalierung, UI, Edge / Multi-Asset | 4     | [`plan-RM-M6.md`](plan-RM-M6.md) — aktiviert 2026-05-13 nach M5-Closure. RM-M6-02 ist abgeschlossen: [`../done/plan-RM-M6-02.md`](../done/plan-RM-M6-02.md); RM-M6-03 ist abgeschlossen: [`../done/plan-RM-M6-03.md`](../done/plan-RM-M6-03.md). [ADR 0007](../../adr/0007-multi-asset-hosting-strategy.md) schliesst `AR-OPEN-006` mit shared Worker als Default. UI, TimescaleDB, Edge und zertifizierungsnahe Regelleistung bleiben nachgelagerte M6-Slices. |
