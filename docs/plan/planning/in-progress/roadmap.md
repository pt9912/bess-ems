...
> RM-M6-02 (Multi-Asset-Hosting-Strategie / `AR-OPEN-006`), weil UI,
> Kubernetes, Edge und Flottensteuerung eine gemeinsame Asset-Topologie
> brauchen. Operator-UI, TimescaleDB, Edge und zertifizierungsnahe
> Regelleistungsintegration bleiben in M6 eingeplant, aber
> trigger-/topologieabhaengig.
>
...
| 🟡     | M6          | Skalierung, UI, Edge / Multi-Asset | 4     | [`plan-RM-M6.md`](plan-RM-M6.md) — aktiviert 2026-05-13 nach M5-Closure. Erster Slice: RM-M6-02 Multi-Asset-Hosting-Strategie zur Schliessung von `AR-OPEN-006`; UI, Kubernetes, TimescaleDB, Edge und zertifizierungsnahe Regelleistung bleiben nachgelagerte M6-Slices. |
...
| 🟡     | RM-M6-02   | Multi-Asset-Flottensteuerung / Hosting-Strategie — erster M6-Slice zur Schliessung von `AR-OPEN-006` (Worker-pro-Asset vs. shared Worker, Asset-Isolation, Locking/Clocking, Metrik-/Persistenzlabels, Sidecar-Topologie). | §28.3                |
