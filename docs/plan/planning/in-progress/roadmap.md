...
> ist abgeschlossen.
>
> **M4 abgeschlossen:** [`../done/plan-RM-M4.md`](../done/plan-RM-M4.md)
...
> Kommentar auf F-04 umgestellt; 9 neue Adapter-Pins. F-04 ist
> abgeschlossen: Production-MQTT ist TLS-/Broker-Auth-fail-closed,
> Plaintext braucht Test-/Simulator-Profil plus Reason. F-06 ist
> abgeschlossen: `ExactlyOnce` braucht `AllowExactlyOnce=true` plus
> Reason.
...
> Security ist seit RM-M4-05 production-fail-closed mit
> `RuntimeProfile=Production`, `SignAndEncrypt` und Policy-Allowlist.
...
> [LH-OPT-009](../../../../spec/lastenheft.md#lh-opt-009--optimierungsergebnis-und-objective-breakdown)-Payload und Invarianten, `IScheduleOptimizer`-Driven-Port,
...
> guarded, sowie Replay-/Reproduzierbarkeitstests ([LH-OPT-009](../../../../spec/lastenheft.md#lh-opt-009--optimierungsergebnis-und-objective-breakdown)).
...
> `PidController` als pure Function — [LH-CTRL-004](../../../../spec/lastenheft.md#lh-ctrl-004--pid-regelung) „Soll", produktive
...
> ([LH-OPT-004](../../../../spec/lastenheft.md#lh-opt-004--zielfunktion) #4 Marktverpflichtungs-Strafkosten unter RM-M2-04,
...
| ------ | ---------- | ------------------------------------------------------------------- | ------------------------- |
| ✅     | RM-M1-01   | C#/.NET Solution-Skeleton mit Projekten gemäß Architektur §4.2 / §5.1 (hexagonale Verzeichnisstruktur) | [LH-NF-001](../../../../spec/lastenheft.md#lh-nf-001--programmiersprache-hauptsystem), [LH-ARCH-001](../../../../spec/lastenheft.md#lh-arch-001--modulare-systemarchitektur)    |
| ✅     | RM-M1-02   | Domain-Modell (BatteryAsset, Telemetry, Command, DataQuality)       | [LH-DOM-001](../../../../spec/lastenheft.md#lh-dom-001--batteriespeicher-modell)..[004](../../../../spec/lastenheft.md#lh-dom-004--datenqualität)           |
| ✅     | RM-M1-03   | Realtime Snapshot Store, Datenfusion, Aging                         | [LH-RT-001](../../../../spec/lastenheft.md#lh-rt-001--realtime-snapshot-store)..[004](../../../../spec/lastenheft.md#lh-rt-004--echtzeitnahe-verarbeitung)            |
| ✅     | RM-M1-04   | State Machine (INIT…EMERGENCY_STOP) inkl. Quittierungslogik         | [LH-SM-001](../../../../spec/lastenheft.md#lh-sm-001--explizite-betriebszustände)..[003](../../../../spec/lastenheft.md#lh-sm-003--quittierung-von-fehlerzuständen)            |
| ✅     | RM-M1-05   | Constraint Limiter (.NET) mit SOC-, Power-, Verfügbarkeitsgrenzen   | [LH-CTRL-002](../../../../spec/lastenheft.md#lh-ctrl-002--constraint-limiter), [LH-SAFE-002](../../../../spec/lastenheft.md#lh-safe-002--kein-laden-außerhalb-soc-grenzen)/3 |
| ✅     | RM-M1-06   | Ramp Limiter (.NET)                                                  | [LH-CTRL-003](../../../../spec/lastenheft.md#lh-ctrl-003--ramp-limiter)               |
| ✅     | RM-M1-07   | Regelzyklus 1 s, sicherer Fallback bei stale/ungültigem Snapshot    | [LH-CTRL-001](../../../../spec/lastenheft.md#lh-ctrl-001--zyklischer-regelkreis)/[007](../../../../spec/lastenheft.md#lh-ctrl-007--fallback-bei-ungültigem-snapshot), [LH-RT-003](../../../../spec/lastenheft.md#lh-rt-003--maximales-messwertalter) |
| ✅     | RM-M1-08   | Optimization-Interface: `IDispatchOptimizer`/`NoOpDispatchOptimizer` für Echtzeit-Single-Step-Dispatch im Regelzyklus; `IScheduleOptimizer` ist Architekturgrenze ohne M1-Implementierung | [LH-OPT-001](../../../../spec/lastenheft.md#lh-opt-001--fahrplanoptimierung) (als Interface), [LH-OPT-007](../../../../spec/lastenheft.md#lh-opt-007--trennung-von-horizon-optimierung-und-echtzeit-dispatch) |
| ✅     | RM-M1-09   | Modbus-TCP-Adapter (Lesen + Schreiben, Mapping über Config)         | [LH-MODB-001](../../../../spec/lastenheft.md#lh-modb-001--modbus-tcp-lesen)..[005](../../../../spec/lastenheft.md#lh-modb-005--timeout)          |
| ✅     | RM-M1-10   | MQTT-Adapter (Telemetrie-Empfang, Command-Publish, Topic-Konvention) | [LH-MQTT-001](../../../../spec/lastenheft.md#lh-mqtt-001--mqtt-telemetrie-empfang)..[003](../../../../spec/lastenheft.md#lh-mqtt-003--mqtt-topic-konvention)         |
| ✅     | RM-M1-11   | Schreibbegrenzung im Adapter unmittelbar vor Versand                | [LH-SAFE-007](../../../../spec/lastenheft.md#lh-safe-007--schreibbegrenzung-vor-feldkommunikation)               |
| ✅     | RM-M1-12   | Statischer Fahrplanimport, `MarketCommitment`-Modell, UTC/DST-Zeitmodell + Day-Ahead-Verfolgung | [LH-MKT-001](../../../../spec/lastenheft.md#lh-mkt-001--day-ahead-fahrplan)/[003](../../../../spec/lastenheft.md#lh-mkt-003--marktverpflichtungen)/[006](../../../../spec/lastenheft.md#lh-mkt-006--priorisierung-von-markt--und-sicherheitsanforderungen)/[007](../../../../spec/lastenheft.md#lh-mkt-007--zeitmodell-für-fahrpläne) |
| ✅     | RM-M1-13   | PostgreSQL-Persistenz: Dapper + Npgsql 9, idempotente DDL, Repos für Telemetrie/Commands/Fahrpläne/Audit, Postgres-Sidecar im Compose-Integrationstest. DI-/Runtime-Wiring bleibt RM-M1-15/19. | [LH-PERSIST-001](../../../../spec/lastenheft.md#lh-persist-001--speicherung-von-messdaten)..[005](../../../../spec/lastenheft.md#lh-persist-005--datenbank)       |
| ✅     | RM-M1-14   | Retention-/Datenvolumen-Konfiguration (dokumentiert)                | [LH-PERSIST-006](../../../../spec/lastenheft.md#lh-persist-006--aufbewahrung-und-datenvolumen)            |
| ✅     | RM-M1-15   | API: Health, Status, Current Command, Schedules, Operator-Stop      | [LH-API-001](../../../../spec/lastenheft.md#lh-api-001--health-endpoint)..[004](../../../../spec/lastenheft.md#lh-api-004--fahrplanabfrage), [LH-API-006](../../../../spec/lastenheft.md#lh-api-006--operator-stop) |
| ✅     | RM-M1-16   | AuthN/AuthZ + Audit-Log für schreibende Endpunkte                   | [LH-API-007](../../../../spec/lastenheft.md#lh-api-007--authentifizierung-und-autorisierung)                |
| ✅     | RM-M1-17   | Strukturierte JSON-Logs mit Reason-Feld + Prometheus-Metrikexport   | [LH-MON-001](../../../../spec/lastenheft.md#lh-mon-001--logging)/[002](../../../../spec/lastenheft.md#lh-mon-002--metriken)/[004](../../../../spec/lastenheft.md#lh-mon-004--entscheidungsbegründung)        |
| ✅     | RM-M1-18   | Konfigurations-Loader, JSON-Schemas für Adapter-Mappings + Startvalidierung | [LH-CONF-001](../../../../spec/lastenheft.md#lh-conf-001--externe-konfiguration)..[003](../../../../spec/lastenheft.md#lh-conf-003--validierung-der-konfiguration), [LH-OPS-001](../../../../spec/lastenheft.md#lh-ops-001--sicherer-start) |
| ✅     | RM-M1-19   | Dockerfile + Docker Compose (`bess-ems` mit Worker/API, Postgres, MQTT-Broker) | [LH-DEPLOY-001](../../../../spec/lastenheft.md#lh-deploy-001--dockerfile)..[003](../../../../spec/lastenheft.md#lh-deploy-003--multi-stage-build), [LH-NF-003](../../../../spec/lastenheft.md#lh-nf-003--betriebssystem)/4 |
| ✅     | RM-M1-20   | Quality-Gates: Lint, Unit/Safety/Integration/Contract/Container, Coverage | [LH-TEST-001](../../../../spec/lastenheft.md#lh-test-001--unit-tests-für-regelung)/[003](../../../../spec/lastenheft.md#lh-test-003--integrationstests-für-protokolladapter)/[006](../../../../spec/lastenheft.md#lh-test-006--sicherheitsfall-tests)/[007](../../../../spec/lastenheft.md#lh-test-007--container-tests), [LH-DOM-007](../../../../spec/lastenheft.md#lh-dom-007--vorzeichenkonvention) |
| ✅     | RM-M1-21   | Makefile als Orchestrierungsschicht über die Docker-Stages aus `docs/user/quality.md`: `.DEFAULT_GOAL=help`, Override-Variablen (`COVERAGE_THRESHOLD`, `LIZARD_MAX_*`, `IMAGE`), Composite-Targets (`gates`, `ci`, `runtime`, `fullbuild`), `-gate`/`-report`-Trennung | [LH-DEPLOY-001](../../../../spec/lastenheft.md#lh-deploy-001--dockerfile)/[002](../../../../spec/lastenheft.md#lh-deploy-002--docker-compose), [LH-TEST-001](../../../../spec/lastenheft.md#lh-test-001--unit-tests-für-regelung)/[006](../../../../spec/lastenheft.md#lh-test-006--sicherheitsfall-tests)/[007](../../../../spec/lastenheft.md#lh-test-007--container-tests) |
| ✅     | RM-M1-22   | Hexagonale Verzeichnis- und Modulstruktur gemäß Architektur §4.2 (`src/hexagon/`, `src/adapters/{driving,driven}/`, `src/infrastructure/`); Driving/Driven-Klassifikation pro Modul | [LH-ARCH-001](../../../../spec/lastenheft.md#lh-arch-001--modulare-systemarchitektur)..[005](../../../../spec/lastenheft.md#lh-arch-005--austauschbare-kommunikationsadapter), [LH-NF-006](../../../../spec/lastenheft.md#lh-nf-006--wartbarkeit) |
...
| ✅     | RM-M1-24   | Go-basierter Blackbox-Simulator `simulators/bess-field-sim` für Modbus/MQTT, Szenario-Fixtures und Runtime-Smoke | [LH-TEST-003](../../../../spec/lastenheft.md#lh-test-003--integrationstests-für-protokolladapter)/[006](../../../../spec/lastenheft.md#lh-test-006--sicherheitsfall-tests)/[007](../../../../spec/lastenheft.md#lh-test-007--container-tests), [LH-PROT-001](../../../../spec/lastenheft.md#lh-prot-001--einheitliches-adapterinterface) |
...
(RM-M2-03/05/07/09 und Anschluss an [LH-OPT-007](../../../../spec/lastenheft.md#lh-opt-007--trennung-von-horizon-optimierung-und-echtzeit-dispatch)/[008](../../../../spec/lastenheft.md#lh-opt-008--einheiten--und-zeitschritt-konsistenz)/[009](../../../../spec/lastenheft.md#lh-opt-009--optimierungsergebnis-und-objective-breakdown) + [LH-PERSIST-007](../../../../spec/lastenheft.md#lh-persist-007--speicherung-von-optimierungsläufen))
...
gehoben; drei weitere [LH-OPT-004](../../../../spec/lastenheft.md#lh-opt-004--zielfunktion)-Komponenten (Marktverpflichtung,
...
| Status | ID         | Inhalt                                                              | LH-Bezug                   |
| ------ | ---------- | ------------------------------------------------------------------- | -------------------------- |
| ✅     | RM-M3-01   | C-ABI `battery_control_core.h` (Snapshot/Limits/Command Structs)    | [LH-NATIVE-002](../../../../spec/lastenheft.md#lh-native-002--stabile-c-abi)/[003](../../../../spec/lastenheft.md#lh-native-003--keine-speicherallokation-über-sprachgrenzen)          |
| ✅     | RM-M3-02   | Implementierung Constraint + Ramp + Statuscode-Fehlerpfade (Sprach-Pivot C++ → C unter RM-M3-09) | [LH-NATIVE-001](../../../../spec/lastenheft.md#lh-native-001--cc-für-performance-kritische-komponenten)/[004](../../../../spec/lastenheft.md#lh-native-004--native-fehlercodes) |
| ✅     | RM-M3-03   | ABI-Versionsfunktion + Startup-Check in .NET                        | [LH-NATIVE-005](../../../../spec/lastenheft.md#lh-native-005--abi-versionierung)              |
| ✅     | RM-M3-04   | P/Invoke-Bindings (`BatteryEms.Adapters.NativeInterop`)              | [LH-NATIVE-001](../../../../spec/lastenheft.md#lh-native-001--cc-für-performance-kritische-komponenten)              |
| ✅     | RM-M3-05   | Routing: Native bevorzugt, .NET-Fallback bei Fehler/Abwesenheit     | [LH-ARCH-006](../../../../spec/lastenheft.md#lh-arch-006--native-core-als-optionaler-beschleuniger), [LH-NF-002](../../../../spec/lastenheft.md#lh-nf-002--performance-kritische-komponenten)     |
| ✅     | RM-M3-06   | Multi-Stage Dockerfile mit Native-Build-Stage (Teil 1 Build-Stage; Teil 2 Runtime-Image-Pfad `/app/native/` + Container-Smoke) | [LH-DEPLOY-003](../../../../spec/lastenheft.md#lh-deploy-003--multi-stage-build)/[004](../../../../spec/lastenheft.md#lh-deploy-004--native-build), [LH-NATIVE-006](../../../../spec/lastenheft.md#lh-native-006--container-build) |
| ✅     | RM-M3-07   | Interop-Tests (Struct Layout, ABI, non-finite-Contract gegen echte `.so`) | [LH-TEST-005](../../../../spec/lastenheft.md#lh-test-005--native-interop-tests)          |
| ✅     | RM-M3-08   | Native-Unit-Tests via doctest 2.4.11 (FetchContent + URL_HASH SHA256-Pinning) | [LH-TEST-001](../../../../spec/lastenheft.md#lh-test-001--unit-tests-für-regelung)        |
| ✅     | RM-M3-09   | Native-Quality-Gates: `native-lint` (clang-tidy), Sanitizer (ASan + UBSan), `native-coverage-gate` (gcovr, 100 % line) | [LH-TEST-005](../../../../spec/lastenheft.md#lh-test-005--native-interop-tests), LH-NATIVE-* |
| ✅     | RM-M3-10   | Native/.NET-Parity-Gate über versionierten Replay-Datensatz `cases.v1.json` (25 Cases) | [LH-ARCH-006](../../../../spec/lastenheft.md#lh-arch-006--native-core-als-optionaler-beschleuniger), [LH-TEST-005](../../../../spec/lastenheft.md#lh-test-005--native-interop-tests) |
| ✅     | RM-M3-11   | Makefile-Erweiterung um native Targets (`native-lint`, `test-native-interop`, `test-native-parity`, `native-coverage-gate`, `native-coverage-report`, `native-coverage-exclusions`); `gates`/`ci` ziehen native Gates mit | LH-NATIVE-*, [LH-TEST-005](../../../../spec/lastenheft.md#lh-test-005--native-interop-tests) |
| ✅     | RM-M3-12   | Doku-/Contract-Sync fuer Native-Policy und Adaptername (quality.md, architecture.md, roadmap.md, plan-RM-M3.md auf kanonischen Adaptername `BatteryEms.Adapters.NativeInterop`, Header-Pfad `native/battery_control_core/include/battery_control_core.h`, Coverage-Scope `native/battery_control_core/src/`, Port `IControlKernel`, Sprache C; M3-Default-Policy = Managed-Fallback, opt-in `AbortOnAbiMismatch` als Production-Policy synchron) | [LH-NATIVE-004](../../../../spec/lastenheft.md#lh-native-004--native-fehlercodes)/[005](../../../../spec/lastenheft.md#lh-native-005--abi-versionierung), [LH-OPS-001](../../../../spec/lastenheft.md#lh-ops-001--sicherer-start) |
| ✅     | RM-M3-13   | PID Native-Slice nach stabiler Constraint/Ramp-Parity (ABI 0.1→0.2 additiv, 4 neue Structs, 4 Reason-Codes, neuer Export `battery_control_core_pid_step`, 100 % Coverage, 21 Wire-Tests durch P/Invoke) | [LH-NATIVE-001](../../../../spec/lastenheft.md#lh-native-001--cc-für-performance-kritische-komponenten)/[004](../../../../spec/lastenheft.md#lh-native-004--native-fehlercodes), [LH-TEST-005](../../../../spec/lastenheft.md#lh-test-005--native-interop-tests) |
...
| Status | ID         | Inhalt                                                              | LH-Bezug                |
| ------ | ---------- | ------------------------------------------------------------------- | ----------------------- |
| ✅     | RM-M5-01   | gRPC-Sidecar `optimization-core` (LP/MILP/MPC) — Detail-Slice [`../done/plan-RM-M5-01.md`](../done/plan-RM-M5-01.md) (abgeschlossen 2026-05-11 inkl. Sub-Slice-C-Korrektur-Pass); gRPC-Transport per [ADR 0005](../../adr/0005-optimization-core-sidecar-transport.md), UDS-Default + mTLS-Cross-Host, In-Process TestSidecar via Grpc.AspNetCore. | [LH-OPT-002](../../../../spec/lastenheft.md#lh-opt-002--unterstützte-optimierungsverfahren)/[003](../../../../spec/lastenheft.md#lh-opt-003--milp-modellierung)/[006](../../../../spec/lastenheft.md#lh-opt-006--solver-abstraktion)      |
| ✅     | RM-M5-02   | MPC-Kernel (State-Space, Kalman, Vorhersagehorizont) — Detail-Slice [`../done/plan-RM-M5-02.md`](../done/plan-RM-M5-02.md) abgeschlossen 2026-05-12 mit Local-OSQP, Kalman-Estimator, Replay-Stempeln, `mpc_runs`-Migration, Worker-Wiring und Production-Gates. | [LH-CTRL-005](../../../../spec/lastenheft.md#lh-ctrl-005--mpc-unterstützung)/[006](../../../../spec/lastenheft.md#lh-ctrl-006--state-space-modelle)         |
| ✅     | RM-M5-03   | Hochfrequente Telemetrie-Filterung im Native Core — Detail-Slice [`../done/plan-RM-M5-03.md`](../done/plan-RM-M5-03.md) abgeschlossen 2026-05-13 mit `battery_control_core_filter_telemetry`, ABI `0.3.0`, Sample-Period-/Drift-Guards, P/Invoke-Wiring und Native-Gates. | [LH-NATIVE-001](../../../../spec/lastenheft.md#lh-native-001--cc-für-performance-kritische-komponenten)           |
| ✅     | RM-M5-04   | Replay-Plattform mit Datensatz-Verwaltung und Sollwertvergleich — Detail-Slice [`../done/plan-RM-M5-04.md`](../done/plan-RM-M5-04.md) abgeschlossen 2026-05-12 mit Manifest-/Fixture-/Golden-Diff-Grundlage, M2/M3-Migration, Replay-Diff-Reports und Sidecar-/MPC-Engine-Vergleichen. | [LH-TEST-004](../../../../spec/lastenheft.md#lh-test-004--replay-tests)             |
| ✅     | RM-M5-05   | Erweiterte Metriken / Solverstatus / Command-Latenz — Detail-Slice [`../done/plan-RM-M5-05.md`](../done/plan-RM-M5-05.md) abgeschlossen 2026-05-12 mit Sidecar-Health, Fallback-/Terminalzustandslabels und Run-Duration. | [LH-MON-002](../../../../spec/lastenheft.md#lh-mon-002--metriken)              |
| ✅     | RM-M5-06   | Container-Orchestrierungstests (Worker + Sidecar) — Detail-Slice [`../done/plan-RM-M5-06.md`](../done/plan-RM-M5-06.md) abgeschlossen 2026-05-12 mit Compose-Gate fuer Sidecar-Commit, Sidecar-Stopp/Fallback, Restart-Recovery und Log-Korrelation. | [LH-TEST-007](../../../../spec/lastenheft.md#lh-test-007--container-tests)             |
| ✅     | RM-M5-07   | `IPriceSeriesSource`-Port + quellenneutraler Preisreihen-Import/API; keine externen Anbieteradapter im Default — Detail-Slice [`../done/plan-RM-M5-07.md`](../done/plan-RM-M5-07.md) abgeschlossen 2026-05-12. | LH-OPEN-003, [LH-MKT-008](../../../../spec/lastenheft.md#lh-mkt-008--tarif--und-preiszeitfenster) |
