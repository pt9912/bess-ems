...
| ⏳     | `make test-integration`        | Modbus, MQTT, PostgreSQL, API über Testserver. Heute scharf: Modbus-Roundtrip (RM-M1-09) und MQTT-Roundtrip (Telemetry + Command/ACK, RM-M1-10) via docker compose mit Mosquitto- und Go-Simulator-Sidecar. PostgreSQL/API folgen mit RM-M1-13/15.                                                | RM-M1-09, RM-M1-10, RM-M1-13, RM-M1-15  |
