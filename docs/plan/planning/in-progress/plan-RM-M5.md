...
RM-M5-01 hat eigenen Slice-Plan [`plan-RM-M5-01.md`](plan-RM-M5-01.md) (🟡 in Korrektur-Pass nach externem Review am 2026-05-11).
**Bezug:**
...
| Status | ID | Paket | DoD |
| ------ | -- | ----- | --- |
| 🟡 | RM-M5-01 | Sidecar `optimization-core` (LP/MILP/MPC) | Slice-Plan: [`plan-RM-M5-01.md`](plan-RM-M5-01.md) — Sub-Slices A/B/D grün, Sub-Slice C 🟡 in Korrektur-Pass nach externem Review am 2026-05-11 (Findings 1+2: lokaler `or_tools`-Fallback + `IFallbackPlanValidator` nicht in `OptimizeAsync` integriert; Finding 3: stale `NotImplementedException`-Kommentar in `BessHostOptions`). Re-Closure mit dem in §5 D-05 vorab gepinnten Replacement-Text nach abgeschlossener Korrektur. |
