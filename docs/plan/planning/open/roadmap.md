...
**Status:** Offen
**Bezug:** [`spec/lastenheft.md`](../../../../spec/lastenheft.md) (§28 MVP-Abgrenzung), [`spec/architecture.md`](../../../../spec/architecture.md) (§13 Native-Core-Phasenmodell)
...
**Ziel:** Ein .NET-only EMS, das Telemetrie liest, einen Day-Ahead-Fahrplan
verfolgt, technisch begrenzt und sicher Commands erzeugt — vollständig
containerisiert, mit Persistenz, AuthN/AuthZ-geschütztem Operator-Stop.
...
| RM-M1-12   | Statischer Fahrplanimport + einfache Day-Ahead-Verfolgung           | LH-MKT-001, LH-MKT-007    |
...
| RM-M1-17   | Strukturierte JSON-Logs mit Reason-Feld                             | LH-MON-001/004            |
| RM-M1-18   | Konfigurations-Loader + Startvalidierung                            | LH-CONF-001..003, LH-OPS-001 |
| RM-M1-19   | Dockerfile + Docker Compose (Worker, API, Postgres, MQTT-Broker)    | LH-DEPLOY-001..003, LH-NF-003/4 |
| RM-M1-20   | Unit-Tests Kernlogik + Sicherheitsfall-Tests                        | LH-TEST-001/006           |
...
**Ziel:** Marktverpflichtungen, Zeitmodell mit Sommerzeit, einfacher
...
| ID         | Inhalt                                                              | LH-Bezug                |
| ---------- | ------------------------------------------------------------------- | ----------------------- |
| RM-M2-01   | Marktverpflichtungen-Modell + Berücksichtigung im Regelkreis        | LH-MKT-003/006          |
...
| RM-M2-07   | Metrik-Export Prometheus (Zykluszeit, Power, Solverzeit)            | LH-MON-002              |
...
| Konfigurations-Schemata     | YAML-Schemata + Validatoren mitwachsen lassen                    |
...
| RM-OPEN-06 | Eigene oder integrierte API-Komponente (siehe AR-OPEN-001)?    | Offen  |
