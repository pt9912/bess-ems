...
**Status:** Offen — Trigger zündet sobald RM-M4-01 (Intraday-Reoptimierung) gezogen wird oder ein Multi-Replica-Optimize-Deployment auf den Tisch kommt; FUP-02 ist Vorbedingung dafür.
**Bezug:**
[`note-RM-M3-followups.md`](note-RM-M3-followups.md) Block B Item 6 (Trigger-Watch-Eintrag),
[`plan-RM-M4.md`](plan-RM-M4.md) (RM-M4-01 ist der erste konkrete Konsument; verlangt Commit-Lock + CAS auf der erwarteten Schedule-Version — siehe `plan-RM-M4.md` §Aktivierungsbedingungen Z. 94 und §Arbeitspakete RM-M4-01 Z. 164),
[`../done/plan-RM-M2-optimization.md`](../done/plan-RM-M2-optimization.md) (RM-M2-OP-OPEN-05 als ursprüngliche Quelle, „M3"-Trigger),
[`../done/plan-RM-M3.md`](../done/plan-RM-M3.md) (M3-Master-Plan, historischer Anker; die ursprüngliche „M2-Folgearbeit Mit M3-Trigger"-Tabelle ist heute ein Stub-Absatz mit Verweis auf die Open-Note Block B),
