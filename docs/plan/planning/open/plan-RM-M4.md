...
| ⬜ | RM-M4-02 | Reservierungs-Modell für Regelleistung + Solver-Constraints | Domain-Modell für Lade-/Entlade-Reserve mit Zeitfenster, Asset-Bezug, Produktfamilie und Richtung; Optimizer begrenzt verfügbare Leistung entsprechend. Tests zeigen, dass Day-Ahead- und Intraday-Optimierung Reserve-Bänder nicht verletzen. Mindestens ein FCR-Profiltest weist symmetrische Reserve um den Baseline-Fahrplan nach; mindestens ein aFRR-Profiltest weist getrennte positive und negative Reservebänder nach. mFRR wird im Produktmodell und in Reservierungsdaten abbildbar, ohne produktive Aktivierung zu verlangen. |
